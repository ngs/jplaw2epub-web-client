...
describe('SearchResults', () => {
  ...
  it('should render keyword search results when keywordItems are provided', () => {
    render(<SearchResults {...defaultProps} keywordItems={mockKeywordItems} searchMode="keyword" totalCount={1} />);
  ...
  it('should show no results message when empty', () => {
    ...
    expect(screen.getByText('検索結果が見つかりませんでした。検索条件を変更してお試しください。')).toBeInTheDocument();
  });
  ...
  it('should calculate correct page count', () => {
    render(<SearchResults {...defaultProps} laws={mockLaws} totalCount={25} itemsPerPage={10} />);
  ...
  it('should highlight current page in pagination', () => {
    render(<SearchResults {...defaultProps} laws={mockLaws} totalCount={50} currentPage={2} />);
  ...
  it('should render correctly with no pagination when single page', () => {
    render(<SearchResults {...defaultProps} laws={mockLaws} totalCount={2} itemsPerPage={10} />);
  ...
  it('should handle keyword search with multiple matches', () => {
    ...
    render(<SearchResults {...defaultProps} keywordItems={[multiMatchItem]} searchMode="keyword" totalCount={1} />);
